...
const RecipeDetail = ({ recipe, searchQuery, onBack }) => {
  if (!recipe) {
    return <p>Please select a recipe to view details.</p>;
  }
    ...
    <div className="recipe-card">
      ...
      <ul>
        {recipe.ingredients.map((ing, i) => (
          <li key={i} dangerouslySetInnerHTML={{ __html: highlightText(ing) }} />
        ))}
      </ul>
